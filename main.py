...
classifier = load_model("https://github.com/Lourini/project/blob/main/Case_1.h5")

#load face
try:
    face_cascade = cv2.CascadeClassifier('https://github.com/Lourini/project/blob/main/haarcascade_frontalface_default.xml')
except Exception:
